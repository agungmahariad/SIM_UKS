			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form method="post" action="{{ url('updaterayon/'.$data->id_rayon) }}">
								@csrf @method('patch')
								<div class="form-group">
									<label>Rayon</label>
									<input type="text" class="form-control" name="rayon" value="{{ $data->rayon }}" required>
								</div>
								<div class="form-group">
									<label>Pembimbing</label>
									<input type="text" class="form-control" name="pembimbing" value="{{ $data->pembimbing }}" required>
								</div>
								<input type="submit" name="tambah" class="btn btn-primary" value="Ubah">
								<a href="{{ url('rayon') }}" class="btn btn-success">Kembali</a>
							</form>
						</div>
					</div>
				</div>
