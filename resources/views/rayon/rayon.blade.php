			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="{{ url('createrayon') }}" class="btn btn-primary">Tambah Rayon</a>
					</div>
								...
								@if (count($data))
									@foreach($data as $row)
										<tr>
											...
											<td align="center">
												<a href="{{ url('editrayon/'.$row->id_rayon) }}" class="btn btn-success">Ubah</a>
												<a href="{{ url('deleterayon/'.$row->id_rayon) }}" class="btn btn-danger" onClick="return confirm('Hapus ?')">Hapus</a>
											</td>
										</tr>
									@endforeach
								@else
