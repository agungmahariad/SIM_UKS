...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Data Rombel</h1>
			</div>
		</div><!--/.row-->
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="{{ url('createrombel') }}" class="btn btn-primary">Tambah Rombel</a>
					</div>
						...
						<div class="row">
							...
							<thead>
								<tr>
									...
									<td align="center">Rombel</td>
									<td align="center" width="400">Jumlah Siswa</td>
								...
								@if (count($data))
									@foreach($data as $row)
										<tr>
											...
											<td align="center">
												<a href="{{ url('editrombel/'.$row->id_rombel) }}" class="btn btn-success">Ubah</a>
												<a href="{{ url('deleterombel/'.$row->id_rombel) }}" class="btn btn-danger" onClick="return confirm('Hapus ?')">Hapus</a>
											</td>
										</tr>
									@endforeach
								@else
