			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form method="post" action="{{ url('updaterombel/'.$data->id_rombel) }}">
								@csrf @method('patch')
								<div class="form-group">
									<label>Rombel</label>
									<input type="text" class="form-control" name="rombel" value="{{ $data->rombel }}" required>
								</div>
								<div class="form-group">
									<label>Jumlah_siswa</label>
									<input type="text" class="form-control" name="jumlah_siswa" value="{{ $data->jumlah_siswa }}" required>
								</div>
								<input type="submit" name="ubah" class="btn btn-primary" value="Ubah">
								<a href="{{ url('rombel') }}" class="btn btn-success">Kembali</a>
							</form>
						</div>
					</div>
				</div>
