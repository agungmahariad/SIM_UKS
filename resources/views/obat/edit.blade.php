			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form method="post" action="{{ url('updateobat/'.$data->id_obat) }}">
								@csrf @method('patch')
								<div class="form-group">
									<label>Nama Obat</label>
									<input type="text" class="form-control" name="obat" value="{{ $data->obat }}" required>
								</div>
								<div class="form-group">
									<label>Kegunaan</label>
									<input type="text" class="form-control" name="kegunaan" value="{{ $data->kegunaan }}" required>
								</div>
								<div class="form-group">
									<label>Stok</label>
								...
								<div class="form-group">
									<label>Expire</label>
									<input type="date" class="form-control" name="expire" value="{{ $data->expire }}" required>
								</div>
								<input type="submit" name="tambah" class="btn btn-primary" value="Ubah">
								<a href="{{ url('obat') }}" class="btn btn-success">Kembali</a>
							</form>
						</div>
					</div>
				</div>
