...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="{{ url('obat') }}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"></use></svg> Obat</a></li>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="{{ url('createobat') }}" class="btn btn-primary">Tambah Obat</a>
					</div>
						...
						<div class="row">
							...
							<thead>
								<tr>
									...
									<td align="center">Kegunaan</td>
									<td align="center">Stok</td>
									<td align="center">Expire</td>
									<td align="center" width="150">Aksi</td>
								</tr>
							</thead>
							<tbody>
								@if (count($data))
									@foreach($data as $row)
										<tr>
											...
											<td>{{ $row->expire }}</td>
											<td align="center">
												<a href="{{ url('editobat/'.$row->id_obat) }}" class="btn btn-success">Ubah</a>
												<a href="{{ url('deleteobat/'.$row->id_obat) }}" class="btn btn-danger" onClick="return confirm('Hapus ?')">Hapus</a>
											</td>
										</tr>
									@endforeach
								@else
