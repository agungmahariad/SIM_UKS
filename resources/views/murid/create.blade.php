			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						@endif
						<div class="col-md-6">
							<form method="post" action="{{ url('savemurid') }}">
								@csrf
								<div class="form-group">
									<label>Nis</label>
									...
									<label>Jurusan</label>
									<select class="form-control" id="datajurusan" name="jurusan" required>
										<option value="">Pilih Jurusan</option>
										@foreach($data['datajurusan'] as $row)
											<option value="{{ $row->jurusan }}">{{ $row->jurusan }}</option>
										@endforeach
									</select>
									<label>Rombel</label>
									<select class="form-control" id="datarombel" name="rombel" required>
										<option value="">Pilih Rombel</option>
										@foreach($data['datarombel'] as $row)
											<option value="{{ $row->rombel }}">{{ $row->rombel }}</option>
										@endforeach
									</select>
									<label>Rayon</label>
									<select class="form-control" id="datarayon" name="rayon" required>
										<option value="">Pilih Rayon</option>
										@foreach ($data['datarayon'] as $row)
